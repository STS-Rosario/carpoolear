...
function autocomplete() {
    ...
    osmApi
        ...
        .then((responseData) => {
            waiting.value = false;
            if (responseData && responseData.filter) {
                ...
                responseData = responseData.filter((o) => {
                    ...
                    let osmType =
                        ['node', 'relation'].indexOf(o.osm_type) >= 0;
                    let county = true;
                    ...
                    if (
                        ...
                        if (o.address.county && !o.address.city) {
                            // Para: Victoria, Entre Rios
                            let city = responseData.find(
                                (c) =>
                                    c.address.city ===
                                        o.address.county &&
                                    c.osm_id !== o.osm_id
                ...
                results.value = responseData.slice(0, 6);
