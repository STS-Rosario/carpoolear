const messages = {
    arg: {
        ...
        equipoCarpoolearAutorAdmin: 'Equipo de Carpoolear ({name} - {id})',
        ...
        enviando: 'Enviando...',
        ticketRespuestaDuplicada: 'Este mensaje ya figura en el ticket.',
        cerrarTicket: 'Cerrar ticket',
        reabrirTicket: 'Reabrir ticket',
        marcarResuelto: 'Marcar como resuelto',
        marcarComoNoResuelto: 'Marcar como no resuelto',
        confirmarMarcarNoResuelto: '¿Marcar este ticket como no resuelto?',
        ticketMarcadoNoResuelto: 'Ticket marcado como no resuelto',
        errorMarcandoNoResuelto: 'No se pudo desmarcar el ticket como resuelto. Intentá de nuevo.',
        estadoResuelto: 'Resuelto',
        marcarNecesitaRevision: 'Marcar necesita revisión',
        confirmarMarcarNecesitaRevision: '¿Marcar este ticket como que necesita revisión?',
        ticketMarcadoNecesitaRevision: 'Ticket marcado como necesita revisión',
        errorMarcandoNecesitaRevision: 'No se pudo marcar el ticket. Intentá de nuevo.',
        quitarNecesitaRevision: 'Quitar necesita revisión',
        confirmarQuitarNecesitaRevision: '¿Quitar la marca de necesita revisión de este ticket?',
        ticketQuitadoNecesitaRevision: 'Se quitó la marca de necesita revisión',
        errorQuitandoNecesitaRevision: 'No se pudo quitar la marca de necesita revisión. Intentá de nuevo.',
        estadoNecesitaRevision: 'Necesita revisión',
        confirmarCierreTicket: '¿Confirmás cerrar este ticket?',
        confirmarMarcarResuelto: '¿Confirmás marcar este ticket como resuelto?',
        mensajeOpcionalCierre: 'Mensaje opcional de cierre',
        mensajeOpcionalResolucion: 'Mensaje opcional de resolución',
        ticketCerrado: 'Ticket cerrado',
        ticketMarcadoResuelto: 'Ticket marcado como resuelto',
        ticketReabierto: 'Ticket reabierto',
        errorCerrandoTicket: 'No se pudo cerrar el ticket. Intente de nuevo',
        errorMarcandoResuelto: 'No se pudo marcar el ticket como resuelto. Intente de nuevo',
        errorReabriendoTicket: 'No se pudo reabrir el ticket. Intente de nuevo',
        prioridad: 'Prioridad',
        prioridadBaja: 'Baja',
        ...
        notaInternaGuardada: 'Nota interna guardada',
        categoriaTicketGuardada: 'Categoria del ticket guardada',
        errorGuardandoNotaInterna: 'No se pudo guardar la nota interna. Intente de nuevo',
        errorGuardandoCategoriaTicket: 'No se pudo guardar la categoria del ticket. Intente de nuevo',
        noHayTickets: 'No hay tickets de mesa de ayuda',
        errorCargandoTickets: 'Error cargando tickets de mesa de ayuda',
        filtroTicketsTodasCategorias: 'Todas las categorías',
        filtroTicketsTodasPrioridades: 'Todas las prioridades',
        filtroTicketsRequiereRespuesta: 'Requiere respuesta del equipo',
        filtroTicketsAbiertos: 'Solo tickets abiertos',
        ticketsVerificacionCuenta: 'Tickets verificación',
        asignarmeTicket: 'Asignarme ticket',
        desasignarmeTicket: 'Desasignarme ticket',
        asignadoA: 'Asignado a',
        ticketAsignado: 'Ticket asignado',
        ticketDesasignado: 'Ticket desasignado',
        errorAsignandoTicket: 'No se pudo asignar el ticket',
        errorDesasignandoTicket: 'No se pudo desasignar el ticket',
        ticketAsignadoAOtroAdmin: 'Este ticket está asignado a {name}. No podés responder hasta que se desasigne.',
        ...
        changelogVersionAyuda: 'Usá semver (ej. 3.2.3). Debe coincidir con la versión de la app para mostrarse una vez.',
        nuevoChangelog: 'Nuevo changelog',
        editarChangelog: 'Editar changelog',
        volverChangelogs: 'Volver a changelogs',
        guardarChangelog: 'Guardar changelog',
        sinChangelogs: 'No hay changelogs',
        errorCargandoChangelogs: 'Error al cargar los changelogs',
        eliminarChangelogConfirm: '¿Eliminar este changelog?',
        detalleChangelog: 'Changelog',
        editarPlantillasRespuestas: 'Editar plantillas de respuestas',
        ...
        nuevaPlantillaRespuesta: 'Nueva plantilla',
        guardarPlantilla: 'Guardar plantilla',
        volverPlantillasRespuestas: 'Volver a plantillas',
        detallePlantillaRespuesta: 'Plantilla de respuesta',
        editarPlantillaRespuesta: 'Editar plantilla',
        eliminarPlantillaConfirm: '¿Eliminar esta plantilla?',
        sinPlantillasRespuestas: 'No hay plantillas de respuesta',
        errorCargandoPlantillasRespuestas: 'Error al cargar las plantillas',
        tablaColumnaId: 'ID',
        creado: 'Creado',
        actualizado: 'Actualizado',
        buscarPlantillasPlaceholder: 'Buscar plantillas…',
        responderConPlantilla: 'Responder con plantilla',
        cerrarModal: 'Cerrar',
        plantillasModalTitulo: 'Elegir plantilla',
        plantillaAcciones: 'Acciones',
        ...
        viajeEnProgreso: 'Tenés un viaje en progreso:',
        compartirUbicacionTiempoReal: 'Compartir mi ubicación en tiempo real',
        compartiendoUbicacionTiempoReal: 'Compartiendo mi ubicación en tiempo real',
        liveLocationTitle: 'Ubicación en tiempo real',
        liveLocationSharingActive: 'Estás compartiendo tu ubicación en tiempo real.',
        liveLocationSharingInactive: 'Compartí tu ubicación en tiempo real con quien quieras.',
        ...
        liveLocationShareIntroPassenger:
            'Podés compartir tu ubicación en tiempo real con familiares, amistades, etc. No necesitan tener una cuenta de Carpoolear para verla. Podés detenerla cuando quieras.',
        ...
        liveLocationStopSharing: 'Detener ubicación en tiempo real',
        liveLocationPermissionDenied: 'No pudimos acceder a tu ubicación. Revisá los permisos del dispositivo.',
        liveLocationBackgroundTitle: 'Carpoolear',
        liveLocationBackgroundMessage: 'Compartiendo tu ubicación en tiempo real.',
        liveLocationWaitingForPosition: 'Esperando la ubicación...',
        liveLocationNotFound: 'Este enlace de ubicación no está disponible.',
        liveLocationSharingStopped: 'La ubicación ya no se está compartiendo.',
        liveLocationSharerLabel: 'Ubicación compartida por {name}',
        liveLocationLastUpdated: 'Última actualización: {datetime}',
        ...
        donaA: 'Aportá a Carpoolear',
        donaACarpoolear: 'Aportá a Carpoolear',
        ...
        ayudanosLead: 'Ayudanos',
        ayudanosOpen: 'plataforma abierta',
        ...
        placeholderComentarioPasajeros:
            'Ej: punto de partida y llegada, tamaño de mochila/bolso, paradas intermedias, si tenés horario flexible...',
        ...
        noninos: 'No infancias',
        aceptaNinos: 'Acepta infancias',
        preferenciaPermitidoFumar: 'Permitido fumar',
        preferenciaPermitidoAnimales: 'Permitido animales',
        preferenciaPermitidoNinos: 'Permitido infancias',
        ...
        valorDonacion: 'Tienes que seleccionar un valor de aporte.',
        ...
        patente: 'Patente',
        patenteDelAuto: 'Patente del auto:',
        autos: 'Autos',
        agregarAuto: 'Agregar auto',
        editarAuto: 'Editar auto',
        autoGuardado: 'Auto guardado correctamente.',
        autosSinRegistros: 'Todavía no cargaste ningún auto.',
        autosIncompleto: 'Incompleto',
        autosCompletarPendientes:
        ...
        seleccionarAuto: 'Seleccionar auto',
        agregarNuevoAutoEnPerfil: '(agregar nuevo en perfil)',
        editarAutosEnViaje: '(editar autos)',
        elegiPatente: 'Elegí un auto',
        seleccionaAuto: 'Tenés que elegir con qué auto viajás.',
        autoEliminado: 'Auto eliminado',
        marca: 'Marca',
        modelo: 'Modelo',
        color: 'Color',
        anio: 'Año',
        anioPlaceholder: 'Año',
        anioRequerido: 'Tenés que ingresar el año del auto.',
        anioInvalido: 'El año debe estar entre 1900 y el año actual.',
        seleccionarMarca: 'Seleccionar marca',
        seleccionarModelo: 'Seleccionar modelo',
        seleccionarColor: 'Seleccionar color',
        marcaOtro: 'Otro',
        modeloOtro: 'Otro',
        marcaOtroPlaceholder: 'Ingresá la marca',
        modeloOtroPlaceholder: 'Ingresá el modelo',
        buscarMarca: 'Buscar marca',
        buscarModelo: 'Buscar modelo',
        completarDatosAuto: 'Completá los datos de tu auto',
        completarDatosAutoDescripcion:
            'Necesitamos la marca, el modelo y el año para publicar el viaje.',
        autoIncompleto: 'Faltan datos del auto (marca, modelo y/o año).',
        marcaRequerida: 'Tenés que elegir una marca.',
        modeloRequerido: 'Tenés que elegir un modelo.',
        colorRequerido: 'Tenés que elegir un color.',
        colorHex: 'Color (hex)',
        colorHexPlaceholder: '#FFFFFF',
        colorHexInvalido: 'El color hex no es válido.',
        adminNavCarCatalog: 'Catálogo de autos',
        adminCarBrands: 'Marcas',
        adminCarModels: 'Modelos',
        adminCarColors: 'Colores',
        adminCarCatalogSync: 'Sincronización Argautos',
        adminCarCatalogSyncNow: 'Sincronizar ahora',
        adminCarCatalogSyncRunning: 'Sincronización en curso...',
        adminCarCatalogSyncLastRun: 'Última sincronización',
        ...
        miembroHaceAnios: 'Miembro hace {count} años',
        miembroHaceUnAnio: 'Miembro hace 1 año',
        miembroHaceMeses: 'Miembro hace {count} meses',
        miembroHaceUnMes: 'Miembro hace 1 mes',
        miembroHaceDias: 'Miembro hace {count} días',
        ...
        identidadNoVerificadaSub:
            'Este usuario aún debe verificar su identidad',
        respondeMensajesPorcentaje: 'Responde el {percent}% de los mensajes',
        tiempoPromedioRespuesta: 'Tiempo promedio: {delay}',
        sinDatosRespuestaTitulo: 'Sin datos de respuesta aún',
        sinDatosRespuestaSub: 'Todavía no hay suficientes mensajes',
        ...
        eliminar: 'Eliminar',
        tripCreationTitleDriver: 'Crear viaje como conductor',
        tripCreationTitlePassenger: 'Crear viaje como pasajero',
        ...
        tripCreationWantsIntermediateStops: 'Quiero agregar paradas intermedias',
        tripCreationStepStopsQuestion: 'Paradas intermedias',
        tripCreationAddStop: 'Agregar parada',
        tripCreationStepLabelRole: 'Tipo',
        tripCreationStepLabelStops: 'Paradas',
        tripCreationStepScheduleQuestion: '¿Cuándo viajás?',
        tripCreationStepCarQuestion: '¿En qué vehículo viajás?',
        tripCreationStepCarSubtitle: 'Seleccioná el vehículo con el que viajás',
        tripCreationAddVehicle: '+ Agregar nuevo vehículo',
        tripSeatLayoutPrompt:
            'Seleccioná la disposición de lugares que concuerde mejor con tu vehículo',
        tripSeatLayoutTip:
            'La idea es que todos viajen cómodos, si es un auto chico, recomendamos seleccionar la opción con 4 lugares.',
        tripSeatLayoutFour: '4 lugares',
        tripSeatLayoutFive: '5 lugares',
        tripSeatLayoutRequired: 'Seleccioná la disposición de lugares.',
        tripCreationStepSeatsQuestion: '¿Cuántos lugares ofrecés en este viaje?',
        tripSeatMapSubtitle:
            'Apagá los asientos donde ya viaja alguien con vos. Los que dejes encendidos son los que se publican.',
        tripSeatMapDriver: 'Vos',
        tripSeatMapDriverRole: 'Conductor',
        tripSeatMapFront: 'Acompañante',
        tripSeatMapRear1: 'Asiento trasero 1',
        tripSeatMapRear2: 'Asiento trasero 2',
        tripSeatMapRear3: 'Asiento trasero 3',
        tripSeatMapAvailable: 'Disponible',
        tripSeatMapUnavailable: 'No disponible',
        ...
        tripCreationStepLastDetailsSubtitle:
            'Antes de publicarlo, chequeá que esté todo bien.',
        tripPrefToggleKids: 'Pueden viajar infancias',
        tripPrefToggleSmoking: 'Se puede fumar',
        tripPrefTogglePets: 'Pueden viajar mascotas',
        tripPrefFriendsSection: 'Amigos',
        tripPrefFriendsTitle: 'Aceptar amigos automáticamente',
        tripPrefFriendsHelper:
            'Tus amigos de Carpoolear reservan sin que tengas que aprobar cada pedido.',
        tripPrefCommentsSection: 'Comentarios para los pasajeros',
        tripReviewEdit: 'Editar',
        tripReviewSectionRoute: 'Recorrido',
        tripReviewSectionVehicle: 'Vehículo',
        tripReviewSectionSeats: 'Lugares disponibles',
        tripReviewSectionContribution: 'Aporte',
        tripReviewSectionPreferences: 'Preferencias',
        tripReviewSeatsCount: '{count} lugares',
        tripReviewContributionPerPerson: 'Contribución por persona',
        tripReviewPrefKids: 'Infancias',
        tripReviewPrefSmoking: 'Fumar',
        tripReviewPrefPets: 'Mascotas',
        tripReviewYes: 'SI',
        tripReviewNo: 'NO',
        tripReviewNoLucrarLead:
            'Carpoolear es colaborativo: la contribución cubre gastos, no genera ganancia.',
        tripReviewMoreInfo: 'Más info',
        tripReviewNoLucrarModalTitle: '¿Por qué no se puede lucrar?',
        tripReviewNoLucrarModalBody:
            '<p>Carpoolear es una comunidad de viajes compartidos, no una app de transporte pago. La idea es dividir gastos, no generar ganancia.</p><p>La contribución máxima se calcula a partir de gastos reales de viaje (combustible + peajes) divididos por la cantidad de asientos.</p><p>Durante la coordinación del viaje, cualquier participante puede pedir ver tickets de combustible y peaje para verificar la división de costos.</p><p>Al tildar el compromiso, aceptás no cobrar más que esa contribución. Cobrar de más puede afectar tu cuenta.</p>',
        tripCreationPublish: 'Publicar viaje',
        tripCreationStepLabelOrigin: 'Origen',
        tripCreationStepLabelDestination: 'Destino',
        tripCreationStepLabelSchedule: 'Fecha',
        tripCreationStepLabelCar: 'Auto',
        tripCreationStepLabelSeats: 'Asientos',
        tripCreationStepLabelDescription: 'Preferencias',
        tripCreationStepLabelLastDetails: 'Revisar',
        tripCreationSuccessTitle: 'Viaje creado',
        tripCreationSuccessAllSet: '¡Todo listo!',
        ...
        tripCreationIncompleteTitle: 'Tenés un viaje incompleto',
        tripCreationIncompleteBody:
            'La creación del viaje no se completó, ¿la terminamos?',
        ...
        debugModeOff: 'Desactivado',
        debugModeEnable: 'Activar',
        debugModeDisable: 'Desactivar',
        ...
        estadoEsperandoFotos: 'Esperando fotos',
        ...
        mostrarResueltos: 'Mostrar resueltos',
        ...
        adminUserIdentityVerificationSection: 'Verificación de cuenta',
        adminIdentityValidationMethod: 'Método de verificación',
        ...
        eliminarTodasLasImagenes: 'Eliminar todas las imágenes',
        confirmarEliminarTodasLasImagenes:
            '¿Eliminar todas las imágenes de este ticket? Los mensajes se conservan.',
        imagenesTicketEliminadas: 'Imágenes del ticket eliminadas',
        errorEliminandoImagenesTicket: 'No se pudieron eliminar las imágenes. Intentá de nuevo.',
        volver: 'Volver',
        accion: 'Acción',
        usuario: 'Usuario',
        ...
        recordarMiCuenta: 'Recordar mi cuenta',
        registrateAcaLink: 'Registrate acá',
        loginLegacyProvidersQuestion:
            '¿Ingresabas con <strong>Facebook</strong> o <strong>Apple</strong>?',
        loginLegacyProvidersContact: 'Contactános para acceder a tu cuenta',
        ...
        donationTierCafe: 'café',
        donationTierBeer: 'pinta de cerveza',
        donationTierFood: 'comida',
        donationUsageNote:
        ...
        noHaySolicitudesDeAsiento: 'No tenés solicitudes de asiento',
        ...
        filtroSolicitudesRecibidas: 'Recibidas',
        filtroSolicitudesEnviadas: 'Enviadas',
        ...
        enterNuevaLinea: 'Enter = nueva línea',
        ctrlEnterEnviar: 'Ctrl+Enter = enviar',
        negrita: 'Negrita',
        cursiva: 'Cursiva',
        codigo: 'Código',
        ...
        adminDashboardVerMas: 'Ver más',
        adminDashboardNoPendingManualVerifications: 'No hay verificaciones manuales pendientes.',
        adminDashboardNoPendingSupportTickets: 'No hay tickets de soporte pendientes.',
        ...
        adminNavExcesoContribucion: 'Exceso de contribución',
        ...
        verViaje: 'Ver viaje',
        excesoContribucionStatusPendiente: 'Pendiente',
        excesoContribucionStatusResuelto: 'Resuelto',
        excesoContribucionStatusDescartado: 'Descartado',
        excesoContribucionStatusEnProceso: 'En proceso',
        marcarExcesoContribucionPendiente: 'Marcar como pendiente',
        marcarExcesoContribucionResuelto: 'Marcar como resuelto',
        marcarExcesoContribucionDescartado: 'Marcar como descartado',
        marcarExcesoContribucionEnProceso: 'Marcar como en proceso',
        ...
        migracionCampoDni: 'DNI',
        migracionCampoTelefono: 'Teléfono',
        migracionCampoFechaCreacion: 'Fecha de creación',
        migracionValorElegido: 'Valor elegido',
        migracionContrasenaConfigurada: 'Contraseña configurada',
        sinFoto: 'Sin foto',
        usuarioDesde: 'Usuario desde',
        ...
        groupChatTripTitle: 'Viaje {date} {hour}',
        groupChatButton: 'Chat grupal',
        groupChatViewParticipants: 'Ver participantes',
        groupChatHideParticipants: 'Ocultar participantes',
        groupChatMuteNotifications: 'Silenciar notificaciones',
        groupChatUnmuteNotifications: 'Activar notificaciones',
        groupChatNotificationsOn: 'Notificaciones activadas',
        groupChatNotificationsOff: 'Notificaciones silenciadas',
        ...
        coordinateTripContributionWarningPassengerPrefix:
            'Recuerde que el conductor deberá pedir la contribución establecida{amountPart}, ya que si se pide más el seguro automotor no los cubrirá en caso de accidentes, y está contra las reglas de uso de Carpoolear. Si lo hace, ',
        ...
        adminUsuariosVerCalificaciones: 'Ver calificaciones',
        adminUsuariosCalificacionesRecibidas: 'Calificaciones recibidas',
        adminUsuariosCalificacionesOtorgadas: 'Calificaciones otorgadas',
        adminUsuariosNoCalificacionesRecibidas:
            'No hay calificaciones recibidas.',
        adminUsuariosNoCalificacionesOtorgadas:
            'No hay calificaciones otorgadas.',
        adminUsuariosVerReferencias: 'Ver referencias',
        adminUsuariosGuardar: 'Guardar',
        adminUsuariosCancelar: 'Cancelar',
        adminUsuariosEdicionGuardada: 'Cambios guardados.',
        adminUsuariosEdicionError: 'No se pudieron guardar los cambios.',
        adminUsuariosCalificacion: 'Calificación',
        adminUsuariosRespuesta: 'Respuesta',
        adminUsuariosComentario: 'Comentario',
        adminUsuariosEditarFila: 'Editar',
        errorCargandoListadoUsuarios: 'Error al cargar el listado de usuarios',
    ...
    en: {
        ...
        equipoCarpoolearAutorAdmin: 'Carpoolear team ({name} - {id})',
        ...
        enviando: 'Sending...',
        ticketRespuestaDuplicada: 'This message was already posted on this ticket.',
        cerrarTicket: 'Close ticket',
        reabrirTicket: 'Reopen ticket',
        marcarResuelto: 'Mark as resolved',
        marcarComoNoResuelto: 'Mark as not resolved',
        confirmarMarcarNoResuelto: 'Mark this ticket as not resolved?',
        ticketMarcadoNoResuelto: 'Ticket marked as not resolved',
        errorMarcandoNoResuelto: 'Could not undo resolved status. Please try again.',
        estadoResuelto: 'Resolved',
        marcarNecesitaRevision: 'Mark needs review',
        confirmarMarcarNecesitaRevision: 'Mark this ticket as needing review?',
        ticketMarcadoNecesitaRevision: 'Ticket marked as needing review',
        errorMarcandoNecesitaRevision: 'Could not update the ticket. Please try again.',
        quitarNecesitaRevision: 'Remove needs review',
        confirmarQuitarNecesitaRevision: 'Remove the needs review mark from this ticket?',
        ticketQuitadoNecesitaRevision: 'Needs review mark removed',
        errorQuitandoNecesitaRevision: 'Could not remove the needs review mark. Please try again.',
        estadoNecesitaRevision: 'Needs review',
        confirmarCierreTicket: 'Confirm closing this ticket?',
        confirmarMarcarResuelto: 'Confirm marking this ticket as resolved?',
        mensajeOpcionalCierre: 'Optional closing message',
        mensajeOpcionalResolucion: 'Optional resolution message',
        ticketCerrado: 'Ticket closed',
        ticketMarcadoResuelto: 'Ticket marked as resolved',
        ticketReabierto: 'Ticket reopened',
        errorCerrandoTicket: 'Could not close the ticket. Please try again.',
        errorMarcandoResuelto: 'Could not mark the ticket as resolved. Please try again.',
        errorReabriendoTicket: 'Could not reopen the ticket. Please try again.',
        prioridad: 'Priority',
        prioridadBaja: 'Low',
        prioridadNormal: 'Normal',
        prioridadAlta: 'High',
        ...
        notaInternaGuardada: 'Internal note saved',
        categoriaTicketGuardada: 'Ticket category saved',
        errorGuardandoNotaInterna: 'Could not save internal note. Please try again.',
        errorGuardandoCategoriaTicket: 'Could not save ticket category. Please try again.',
        noHayTickets: 'No help desk tickets',
        errorCargandoTickets: 'Error loading help desk tickets',
        filtroTicketsTodasCategorias: 'All categories',
        filtroTicketsTodasPrioridades: 'All priorities',
        filtroTicketsRequiereRespuesta: 'Needs team reply',
        filtroTicketsAbiertos: 'Open tickets only',
        ticketsVerificacionCuenta: 'Verification tickets',
        asignarmeTicket: 'Assign ticket to me',
        desasignarmeTicket: 'Unassign ticket from me',
        asignadoA: 'Assigned to',
        ticketAsignado: 'Ticket assigned',
        ticketDesasignado: 'Ticket unassigned',
        errorAsignandoTicket: 'Could not assign ticket',
        errorDesasignandoTicket: 'Could not unassign ticket',
        ticketAsignadoAOtroAdmin: 'This ticket is assigned to {name}. You cannot reply until it is unassigned.',
        ...
        changelogVersionAyuda: 'Use semver (e.g. 3.2.3). Must match the app version to show once.',
        nuevoChangelog: 'New changelog',
        editarChangelog: 'Edit changelog',
        volverChangelogs: 'Back to changelogs',
        guardarChangelog: 'Save changelog',
        sinChangelogs: 'No changelogs yet',
        errorCargandoChangelogs: 'Error loading changelogs',
        eliminarChangelogConfirm: 'Delete this changelog?',
        detalleChangelog: 'Changelog',
        editarPlantillasRespuestas: 'Edit reply templates',
        ...
        accionVer: 'View',
        accionEditar: 'Edit',
        accionDuplicar: 'Duplicate',
        accionEliminar: 'Delete',
        nuevaPlantillaRespuesta: 'New template',
        guardarPlantilla: 'Save template',
        volverPlantillasRespuestas: 'Back to templates',
        detallePlantillaRespuesta: 'Reply template',
        editarPlantillaRespuesta: 'Edit template',
        eliminarPlantillaConfirm: 'Delete this template?',
        sinPlantillasRespuestas: 'No reply templates yet',
        errorCargandoPlantillasRespuestas: 'Error loading templates',
        tablaColumnaId: 'ID',
        creado: 'Created',
        actualizado: 'Updated',
        buscarPlantillasPlaceholder: 'Search templates…',
        responderConPlantilla: 'Reply with template',
        cerrarModal: 'Close',
        plantillasModalTitulo: 'Choose template',
        plantillaAcciones: 'Actions',
        ...
        guardando: 'Saving...',
        Lugares: 'Seats',
        lugaresLibres: 'Available seats',
        libres: 'available',
        Lugar: 'Seat',
        libre: 'available',
        Ver: 'View',
        Carpooleado: 'Carpooled',
        viajeEnProgreso: 'You have a trip in progress:',
        compartirUbicacionTiempoReal: 'Share my real-time location',
        compartiendoUbicacionTiempoReal: 'Sharing my real-time location',
        liveLocationTitle: 'Live location',
        liveLocationSharingActive: 'You are sharing your live location.',
        liveLocationSharingInactive: 'Share your live location with anyone you choose.',
        liveLocationShareIntroDriver:
        ...
        liveLocationStopSharing: 'Stop live location sharing',
        liveLocationPermissionDenied: 'We could not access your location. Check your device permissions.',
        liveLocationBackgroundTitle: 'Carpoolear',
        liveLocationBackgroundMessage: 'Sharing your live location.',
        liveLocationWaitingForPosition: 'Waiting for location...',
        liveLocationNotFound: 'This location link is not available.',
        liveLocationSharingStopped: 'Location is no longer being shared.',
        liveLocationSharerLabel: 'Location shared by {name}',
        liveLocationLastUpdated: 'Last updated: {datetime}',
        ...
        donaA: 'Contribute to Carpoolear',
        donaACarpoolear: 'Contribute to Carpoolear',
        ...
        ayudanosLead: 'Help us',
        ayudanosOpen: 'open',
        ayudanosCollab: 'collaborative',
        ayudanosNonprofit: 'non-profit',
        ...
        placeholderComentarioPasajeros:
            'E.g.: pickup and drop-off area, backpack/bag size, intermediate stops, flexible schedule...',
        ...
        valorDonacion: 'You must select a contribution amount.',
        correctamenteSubscripto:
        ...
        patenteDelAuto: 'Vehicle license plate:',
        autos: 'Vehicles',
        agregarAuto: 'Add vehicle',
        editarAuto: 'Edit vehicle',
        autoGuardado: 'Vehicle saved successfully.',
        autosSinRegistros: 'You have not added any vehicles yet.',
        autosIncompleto: 'Incomplete',
        autosCompletarPendientes:
        ...
        editarAutosEnViaje: '(edit vehicles)',
        elegiPatente: 'Choose a car',
        seleccionaAuto: 'You must choose which vehicle you are driving.',
        autoEliminado: 'Vehicle removed',
        marca: 'Make',
        modelo: 'Model',
        color: 'Color',
        anio: 'Year',
        anioPlaceholder: 'Year',
        anioRequerido: 'You must enter the vehicle year.',
        anioInvalido: 'The year must be between 1900 and the current year.',
        seleccionarMarca: 'Select make',
        seleccionarModelo: 'Select model',
        seleccionarColor: 'Select color',
        marcaOtro: 'Other',
        modeloOtro: 'Other',
        marcaOtroPlaceholder: 'Enter make',
        modeloOtroPlaceholder: 'Enter model',
        buscarMarca: 'Search make',
        buscarModelo: 'Search model',
        completarDatosAuto: 'Complete your vehicle details',
        completarDatosAutoDescripcion:
            'We need the make, model, and year before you can publish the trip.',
        autoIncompleto: 'Vehicle details are missing (make, model, and/or year).',
        marcaRequerida: 'You must choose a make.',
        modeloRequerido: 'You must choose a model.',
        colorRequerido: 'You must choose a color.',
        colorHex: 'Color (hex)',
        colorHexPlaceholder: '#FFFFFF',
        colorHexInvalido: 'The hex color is not valid.',
        adminNavCarCatalog: 'Vehicle catalog',
        adminCarBrands: 'Makes',
        adminCarModels: 'Models',
        adminCarColors: 'Colors',
        adminCarCatalogSync: 'Argautos sync',
        adminCarCatalogSyncNow: 'Sync now',
        adminCarCatalogSyncRunning: 'Sync in progress...',
        adminCarCatalogSyncLastRun: 'Last sync',
        ...
        miembroHaceAnios: 'Member for {count} years',
        miembroHaceUnAnio: 'Member for 1 year',
        miembroHaceMeses: 'Member for {count} months',
        miembroHaceUnMes: 'Member for 1 month',
        miembroHaceDias: 'Member for {count} days',
        ...
        identidadNoVerificadaSub:
            'This user still needs to verify their identity',
        respondeMensajesPorcentaje: 'Replies to {percent}% of messages',
        tiempoPromedioRespuesta: 'Average time: {delay}',
        sinDatosRespuestaTitulo: 'No response data yet',
        sinDatosRespuestaSub: 'Not enough messages yet',
        contactoPrivacidadPerfil:
        ...
        eliminar: 'Delete',
        tripCreationTitleDriver: 'Create trip as driver',
        tripCreationTitlePassenger: 'Create trip as passenger',
        ...
        tripCreationWantsIntermediateStops: 'I want to add intermediate stops',
        tripCreationStepStopsQuestion: 'Intermediate stops',
        tripCreationAddStop: 'Add stop',
        tripCreationStepLabelRole: 'Type',
        tripCreationStepLabelStops: 'Stops',
        tripCreationStepScheduleQuestion: 'When are you traveling?',
        tripCreationStepCarQuestion: 'Which vehicle are you using?',
        tripCreationStepCarSubtitle: 'Select the vehicle you will travel with',
        tripCreationAddVehicle: '+ Add a new vehicle',
        tripSeatLayoutPrompt:
            'Select the seat layout that best matches your vehicle',
        tripSeatLayoutTip:
            'Everyone should travel comfortably; for a small car, we recommend the 4-seat option.',
        tripSeatLayoutFour: '4 seats',
        tripSeatLayoutFive: '5 seats',
        tripSeatLayoutRequired: 'Select a seat layout.',
        tripCreationStepSeatsQuestion: 'How many seats are you offering on this trip?',
        tripSeatMapSubtitle:
            'Turn off seats where someone is already traveling with you. Seats left on are the ones published.',
        tripSeatMapDriver: 'You',
        tripSeatMapDriverRole: 'Driver',
        tripSeatMapFront: 'Front passenger',
        tripSeatMapRear1: 'Rear seat 1',
        tripSeatMapRear2: 'Rear seat 2',
        tripSeatMapRear3: 'Rear seat 3',
        tripSeatMapAvailable: 'Available',
        tripSeatMapUnavailable: 'Unavailable',
        ...
        tripCreationStepLastDetailsSubtitle:
            'Before publishing, check that everything looks right.',
        tripPrefToggleKids: 'Children can travel',
        tripPrefToggleSmoking: 'Smoking allowed',
        tripPrefTogglePets: 'Pets can travel',
        tripPrefFriendsSection: 'Friends',
        tripPrefFriendsTitle: 'Accept friends automatically',
        tripPrefFriendsHelper:
            'Your Carpoolear friends can book without you approving each request.',
        tripPrefCommentsSection: 'Comments for passengers',
        tripReviewEdit: 'Edit',
        tripReviewSectionRoute: 'Route',
        tripReviewSectionVehicle: 'Vehicle',
        tripReviewSectionSeats: 'Available seats',
        tripReviewSectionContribution: 'Contribution',
        tripReviewSectionPreferences: 'Preferences',
        tripReviewSeatsCount: '{count} seats',
        tripReviewContributionPerPerson: 'Contribution per person',
        tripReviewPrefKids: 'Children',
        tripReviewPrefSmoking: 'Smoking',
        tripReviewPrefPets: 'Pets',
        tripReviewYes: 'YES',
        tripReviewNo: 'NO',
        tripReviewNoLucrarLead:
            'Carpoolear is collaborative: the contribution covers costs, it does not generate profit.',
        tripReviewMoreInfo: 'More info',
        tripReviewNoLucrarModalTitle: 'Why can’t you profit?',
        tripReviewNoLucrarModalBody:
            '<p>Carpoolear is a shared-rides community, not a paid transport app. The idea is to split costs, not make a profit.</p><p>The maximum contribution is based on real trip costs (fuel + tolls) divided by the number of seats.</p><p>While coordinating the trip, any participant can ask to see fuel and toll receipts to verify the cost split.</p><p>By checking the commitment, you agree not to charge more than that contribution. Overcharging can affect your account.</p>',
        tripCreationPublish: 'Publish trip',
        tripCreationStepLabelOrigin: 'Origin',
        tripCreationStepLabelDestination: 'Destination',
        tripCreationStepLabelSchedule: 'Date',
        tripCreationStepLabelCar: 'Car',
        tripCreationStepLabelSeats: 'Seats',
        tripCreationStepLabelDescription: 'Preferences',
        tripCreationStepLabelLastDetails: 'Review',
        tripCreationSuccessTitle: 'Trip created',
        tripCreationSuccessAllSet: 'All set!',
        ...
        tripCreationIncompleteTitle: 'You have an incomplete trip',
        tripCreationIncompleteBody:
            'Trip creation was not finished. Do you want to complete it?',
        ...
        estadoEsperandoFotos: 'Waiting for photos',
        ...
        adminUserIdentityVerificationSection: 'Account verification',
        adminIdentityValidationMethod: 'Verification method',
        adminIdentityValidationMethodMercadoPago: 'Mercado Pago',
        adminIdentityValidationMethodManual: 'Manual',
        identity_validated_at: 'Verified at',
        identity_validation_rejected_at: 'Rejected at',
        identity_validation_reject_reason: 'Rejection reason',
        validate_by_date: 'Verification deadline',
        ...
        eliminarTodasLasImagenes: 'Delete all images',
        confirmarEliminarTodasLasImagenes:
            'Delete all images for this ticket? Messages will be kept.',
        imagenesTicketEliminadas: 'Ticket images deleted',
        errorEliminandoImagenesTicket: 'Could not delete the images. Please try again.',
        volver: 'Back',
        accion: 'Action',
        usuario: 'User',
        ...
        buscoTitulo: 'Search...',
        precioAsiento: 'Contribution per person (including the person driving)',
        ...
        recordarMiCuenta: 'Remember my account',
        registrateAcaLink: 'Register here',
        loginLegacyProvidersQuestion:
            'Did you used to log in with <strong>Facebook</strong> or <strong>Apple</strong>?',
        loginLegacyProvidersContact: 'Contact us to access your account',
        ...
        donationTierCafe: 'coffee',
        donationTierBeer: 'a pint of beer',
        donationTierFood: 'a meal',
        donationUsageNote:
        ...
        noHaySolicitudesDeAsiento: 'You have no seat requests',
        ...
        tienesQueSeleccionarDonacion: 'You must select a contribution amount',
        ...
        filtroSolicitudesRecibidas: 'Received',
        filtroSolicitudesEnviadas: 'Sent',
        ...
        tripDetailPageTitle: 'Trip detail',
        tripDetailSection: 'Details',
        tripDetailDriverMessage: 'Driver message',
        tripDetailConditions: 'Characteristics',
        tripDetailJoined: 'Already joined',
        tripDetailStatDuration: 'Estimated time',
        ...
        enterNuevaLinea: 'Enter = new line',
        ctrlEnterEnviar: 'Ctrl+Enter = send',
        negrita: 'Bold',
        cursiva: 'Italic',
        codigo: 'Code',
        ...
        adminDashboardVerMas: 'View more',
        adminDashboardNoPendingManualVerifications: 'No pending manual verifications.',
        adminDashboardNoPendingSupportTickets: 'No pending support tickets.',
        ...
        adminNavExcesoContribucion: 'Excess contribution',
        ...
        ticketSoporte: 'Support ticket',
        datosViaje: 'Trip data',
        verViaje: 'View trip',
        excesoContribucionStatusPendiente: 'Pending',
        excesoContribucionStatusResuelto: 'Resolved',
        excesoContribucionStatusDescartado: 'Dismissed',
        excesoContribucionStatusEnProceso: 'In progress',
        marcarExcesoContribucionPendiente: 'Mark as pending',
        marcarExcesoContribucionResuelto: 'Mark as resolved',
        marcarExcesoContribucionDescartado: 'Mark as dismissed',
        marcarExcesoContribucionEnProceso: 'Mark as in progress',
        ...
        migracionCampoDni: 'ID number',
        migracionCampoTelefono: 'Phone',
        migracionCampoFechaCreacion: 'Creation date',
        migracionValorElegido: 'Chosen value',
        migracionContrasenaConfigurada: 'Password set',
        sinFoto: 'No photo',
        usuarioDesde: 'User since',
        ...
        groupChatTripTitle: 'Trip {date} {hour}',
        groupChatButton: 'Group chat',
        groupChatViewParticipants: 'View participants',
        groupChatHideParticipants: 'Hide participants',
        groupChatMuteNotifications: 'Mute notifications',
        groupChatUnmuteNotifications: 'Unmute notifications',
        groupChatNotificationsOn: 'Notifications on',
        groupChatNotificationsOff: 'Notifications muted',
        coordinateTripContributionWarningDriver:
        ...
        coordinateTripContributionWarningPassengerPrefix:
            'Remember that the driver must request the established contribution{amountPart}, because if more is requested auto insurance will not cover you in case of accidents, and it is against Carpoolear usage rules. If it happens, ',
        ...
        adminUsuariosVerCalificaciones: 'View ratings',
        adminUsuariosCalificacionesRecibidas: 'Ratings received',
        adminUsuariosCalificacionesOtorgadas: 'Ratings given',
        adminUsuariosNoCalificacionesRecibidas: 'No ratings received.',
        adminUsuariosNoCalificacionesOtorgadas: 'No ratings given.',
        adminUsuariosVerReferencias: 'View references',
        adminUsuariosGuardar: 'Save',
        adminUsuariosCancelar: 'Cancel',
        adminUsuariosEdicionGuardada: 'Changes saved.',
        adminUsuariosEdicionError: 'Could not save changes.',
        adminUsuariosCalificacion: 'Rating',
        adminUsuariosRespuesta: 'Reply',
        adminUsuariosComentario: 'Comment',
        adminUsuariosEditarFila: 'Edit',
        errorCargandoListadoUsuarios: 'Error loading user list',
        adminTrips: 'Admin trips',
        ocupados: 'Occupied',
        activar: 'Activate',
        ocultar: 'Hide',
