const messages = {
    arg: {
        ...
        apellido: 'Apellido',
        email: 'Email',
        emailVerification: 'Email (confirmación)',
        emailVerificationPlaceholder: 'Ingrese nuevamente su email',
        password: 'Contraseña',
        ...
        tildaOpcionDatosVisibles:
            'Seleccioná esta opción y guardá los cambios si quieres que estos datos sean visible para cualquier usuario que acceda tu perfil. Sino estos datos solo serán visibles para los pasajeros que confirmes en tu viaje, o para el conductor del viaje al que te subas y te confirme.',
        ...
        cambioFacebook:
            'Facebook cambio sus políticas y no podemos llevarte al perfil de esta persona, pero te ayudamos a buscarlo.',
        ...
        correoUsado:
            'El correo asociado a su cuenta de facebook, ya tiene asociada una cuenta en Carpoolear. Por favor, ingresé utilizando el login por email. Si no recuerda su clave, cliqueé en olvidé mi contraseña.',
        fecha: 'Fecha',
        monto: 'Monto',
        estado: 'Estado',
        viaje: 'Viaje',
    ...
    chl: {
        ...
        siSosConductorDatosVisibles:
            'Si sos conductor, estos datos son visibles para los pasajero que hayas confirmado en tu viaje. Si sos pasajero, estos datos son visibles para el conductor del viaje al que te haya subido y estés confirmado.',
        tildaOpcionDatosVisibles:
            'Tilda esta opción (y guardá cambios) si quieres que estos datos sean visible para cualquier usuario que acceda tu perfil. Sino estos datos solo serán visibles para los pasajeros que confirmes en tu viaje, o para el conductor del viaje al que te subas y te confirme.',
