const messages = {
    arg: {
        ...
        donationUsageNote:
            'Todas las donaciones son utilizadas para mejorar la plataforma, pagar costos de servidores, programación, soporte, etc. Tu aporte ayuda a mantener a Carpoolear vivo, junto al trabajo voluntario.',
        elegiPropiaAventura: 'Elegí tu propia aventura',
        conoceMasDonar: 'Conocé más sobre donaciones',
        continuarSinDonar: 'Continuar sin donar',
    ...
    en: {
        ...
        donationUsageNote:
            'All donations are used to improve the platform, pay for servers, development, support, and more. Your contribution helps keep Carpoolear alive, alongside volunteer work.',
        elegiPropiaAventura: 'Choose your own adventure',
        conoceMasDonar: 'Learn more about donations',
        continuarSinDonar: 'Continue without donating',
